...
import { Search, Clock, Phone, Mail, MapPin, Calendar, CheckCircle, XCircle } from 'lucide-react';
    ...
    <div className="p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600">Manage doctor availability and schedules</p>
        </div>
          ...
          <div key={d.id} className="bg-white rounded-lg shadow-sm p-4 flex flex-col">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="px-3 py-1 bg-blue-600 text-white rounded text-sm">Book</button>
              </div>
            </div>
          </div>
        ))}
